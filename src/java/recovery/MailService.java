...
public class MailService {
    private final Logger LOGGER = Logger.getLogger("package.recovery");
    ...
    private static final String emailBody = "<div class=\"\"><div class=\"aHl\"></div><div id=\":13j\" tabindex=\"-1\"></div><div id=\":13c\" class=\"ii gt\" jslog=\"20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.\"><div id=\":14n\" class=\"a3s aiL msg6794591027225329141\"><u></u>\n"
            ...
            + "<p>It looks like you have forgot your password, don't worry, as we gave you a new one to use temporaly: " + recuperacion + "\n"
            + "\n"
            + "\n"
            + "\n"
            + "           \n"
    ...
    public MailService(String receiver) {
        //Encrypt the data
